...
import { Alert } from '../../utils/alertService'; // ✅ استيراد خدمة التنبيهات
...
const TimeTracking = () => {
  ...
  const handleClockIn = async () => {
    try {
      ...
      // ✅ عرض رسالة خطأ واضحة (Alert) عند الفشل (مثل عدم وجود شيفت)
            ...
            {todayStatus ? (
              <div className="space-y-4">
                ...
                {todayStatus.current_shift ? (
                  ...
                  <div className="bg-red-50 p-4 rounded-lg border border-red-200 mt-2 text-center">
                     <p className="text-red-700 font-medium">No shift scheduled for today</p>
                  </div>
                )}
              </div>
            ) : (
